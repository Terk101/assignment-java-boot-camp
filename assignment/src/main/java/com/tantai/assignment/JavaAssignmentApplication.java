...
@ComponentScan(basePackages = {"com.tantai.assignment"})
public class JavaAssignmentApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        productToCart.setProductId(1);
        productToCart.setQty(2);
        shoppingCartService.addProductToCart(Collections.singletonList(productToCart), customer.getId1());

        shoppingCartService.checkoutProduct(Collections.singletonList(1), customer.getId1());
    }
}
